...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        """
        This initialises a KNNImputer  with param specified in the training_pipeline and return a 
        pipline object with KNNImputer obj as the first step
        ...
        try:
            imputer:KNNImputer=KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS) #the ** means we would be getting a key value pair 
            logging.info(f"Initialied KNNImputer with the folowing params {DATA_TRANSFORMATION_IMPUTER_PARAMS}")
